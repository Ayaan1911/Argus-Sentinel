...
export default function Sidebar() {
  ...
  return (
    <div className="w-16 md:w-60 bg-surface border-r border-bordercolor flex flex-col justify-between shrink-0 h-full transition-all">
      <div className="p-2 md:p-4">
        <div className="mb-8 px-1 md:px-2 pt-2 flex items-center gap-2">
          ...
          <span className="hidden md:inline text-textpri font-bold tracking-wide text-sm">SENTINEL</span>
        </div>
